...
ord_pmt = (balance * annualInterestRate / 12) / (1 - (1 + annualInterestRate / 12) ** (-12))
annuity_due = ord_pmt * (1 / (1 + (annualInterestRate / 12)))
print('Lowest Payment: {0}'.format(round(annuity_due, 2)))
